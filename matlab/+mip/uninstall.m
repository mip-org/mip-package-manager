function uninstall(packageNames)
    ...
    %
    % Args:
    %   packageNames - Package name(s) to uninstall
    ...
    for i = 1:length(packageNames)
        ...
        if ~exist(pkgDir, 'dir')
            ...
            requestedPackages = [requestedPackages, {pkgName}]; %#ok<AGROW>
        end
    end
    ...
    for i = 1:length(requestedPackages)
        ...
        allToUninstall = [allToUninstall, reverseDeps]; %#ok<AGROW>
    end
...
function uninstallOrder = buildUninstallOrder(packagesToUninstall, packagesDir)
    ...
    function visit(pkgName)
        ...
        uninstallOrder = [uninstallOrder, {pkgName}]; %#ok<AGROW>
    end
